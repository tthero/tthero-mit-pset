...
# For Python 3.7:
# See below: on StandardRobot.updatePositionAndClean()
...
#     robot = [robot_type(room, 1) for _ in range(3)]
#     anim = ps2_visualize.RobotVisualization(1, 20, 20, delay)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    return sum(trial_ticks) / num_trials
...
#     plot.
#
showPlot1("Mean number of time-steps to clean the room vs number of robots", \
          "Number of robots", "Mean number of time-steps")
#
...
#     plot.
#
showPlot2("Mean number of time-steps to clean the room vs aspect ratio of room", \
          "Aspect ratio (width/height)", "Mean number of time-steps")
#
