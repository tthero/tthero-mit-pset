...
def compChooseWord(hand, wordList, n):
    ...
    """
    # First, join the words with newline to get the string
    temp = '\n'.join(wordList)
    # Then, get unique set of chars
    charSet = ''.join(set(hand))
    ...
    while True:
        ...
        if choice == 'n':
            ...
            while gaming:
                ...
                if choice == 'u' or choice == 'c':
                    print()
                    # Gets new hand
                    hand = dealHand(HAND_SIZE)
                    # If user inputs 'u'
                    if choice == 'u':
                        # User plays the game, playHand(hand, wordList, HAND_SIZE)
